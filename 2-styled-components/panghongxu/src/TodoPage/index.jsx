...
const TodoPage = (props) => {
    console.log(props.completeCount);
    return (
        <TodoApp>
            <Header>
                <h1>todos</h1>
                ...
                <button onClick={props.addTodoWords}>ADD</button>
            </Header>
            <TodoBody primary={props.todoList.length}>
                <CheckBox type="checkbox" onClick={props.checkedAll}></CheckBox>
            ...
            <Footer primary={props.todoList.length}>
                ...
                <UlBottom primary={props.todoList.length}>
                    <li><a href="javascript:void(0)" className={props.botton_status === 0 ? "selected" : ""} onClick={() => props.showAll()}>All</a></li>
                    <span> </span>
                    <li><a href="javascript:void(0)" className={props.botton_status === 1 ? "selected" : ""} onClick={() => props.active()}>Active</a></li>
                    <span> </span>
                    <li><a href="javascript:void(0)" className={props.botton_status === 2 ? "selected" : ""} onClick={() => props.complete()}>Completed</a></li>
                </UlBottom>
        ...
        <div>
            {
                props.data.map(element1 =>
                    <UlList key={element1.id} style={{ "display": element1.show }}>
                        <li  className={element1.status === "complete" ? "completed":""}>
                            ...
                            <input className="editing edit" value={element1.content} onChange = {() => props.CheckedUpdateWords(element1.id, props.data)}></input>
                        </li>
                    </UlList>
                )
            }
