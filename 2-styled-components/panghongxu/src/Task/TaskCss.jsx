                    ...
                    <ul className="todo-list">
                        {taskList.map((task) => {
                            ...
                            <li key={task.id} className={task.completed ? "completed" : ""}>
                                <div className="view">
                                    <input value={task.id} onChange={taskStatusChange} onClick={toggleTask} className="toggle" type="checkbox" checked={task.completed ? "checked" : false}/>
...
const TaskHtmlStyled = styled(TaskHtml)`
    button {
        margin: 0;
        padding: 0;
        border: 0;
