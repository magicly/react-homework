    ...
    return (
        <Router>
            <Footer>
                ...
                <FooterUl>
                    <li>
                        <Link state={props.todoState === 1 ? true : false} to="/" onClick={props.allTodoTask}>全部</Link>
                    </li>
                    <li>
                        <Link state={props.todoState === 2 ? true : false} to="/complete" onClick={props.completeTodoTask}>完成</Link>
                    </li>
                    <li>
                        <Link state={props.todoState === 3 ? true : false} to="/unfinished" onClick={props.unfinishedTodoTask}>未完成</Link>
                    </li>
                    <Route exact path="/" />
                    <Route path="/complete" />
