...
class Login extends Component{
    constructor(props){
        ...
        if (this.props.location.state) {
            ...
            this.from = this.from === "/logout" ? "/" : this.from;
        }
    ...
    render (){
        ...
        return <Content>
            <h2>用户登录</h2>
            <Row>用户名:  <input type="text" value={this.state.loginName} onChange={this.changeLoginName} /></Row>
            <Row>密码:  <input type="password" value={this.state.password} onChange={this.changePassword} /></Row>
            <div><LoginButton onClick={this.loginIn}>登 录</LoginButton></div>
